...
test('production unblocker emits complete public-safe planning report', () => {
  ...
  assert.equal(report.package.version, '0.1.17');
  assert.equal(report.package.source_version, '0.1.17');
  assert.equal(report.package.current_public_version, '0.1.16');
  ...
  assert.ok(report.operator_next_commands.some((entry) => entry.command === 'npm run registry:verify -- --package enigma-memory --version 0.1.17 --execute'));
