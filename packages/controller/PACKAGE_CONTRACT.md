...
Artifacts contain schema ids, refs, counts, hashes, statuses, and time buckets. They exclude unredacted memory material, prompts, transcripts, local absolute paths, credentials, tokens, private keys, account/customer identifiers, provider payloads, signing material, and realistic private examples.

## Schemas

Public schemas use JSON Schema draft 2020-12 and schema ids:

- `enigma.consent_grant.v1`
