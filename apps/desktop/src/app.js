...
export function renderMemoryDriveDashboard(state = createDesktopState()) {
  ...
  const updateStatus = normalizePublicStatus(state.desktopUpdate?.status, ['unknown', 'checking', 'current', 'available', 'blocked_unsigned', 'blocked_downgrade', 'blocked_channel', 'blocked_version', 'installing', 'ready', 'error'], 'unknown');
...
function updateDesktopUpdateStatusState(state, action) {
  ...
  return bump({
    ...
    desktopUpdate: {
      ...state.desktopUpdate,
      status: normalizePublicStatus(update.status, ['unknown', 'checking', 'current', 'available', 'blocked_unsigned', 'blocked_downgrade', 'blocked_channel', 'blocked_version', 'installing', 'ready', 'error'], state.desktopUpdate.status),
